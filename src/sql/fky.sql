...
ALTER TABLE ${RESULTS_SCHEMA}.COHORT_DEFINITION ADD CONSTRAINT fpk_COHORT_DEFINITION_definition_type_concept_id FOREIGN KEY (definition_type_concept_id) REFERENCES ${CDM_SCHEMA}.CONCEPT (CONCEPT_ID);
ALTER TABLE ${RESULTS_SCHEMA}.COHORT_DEFINITION ADD CONSTRAINT fpk_COHORT_DEFINITION_subject_concept_id FOREIGN KEY (subject_concept_id) REFERENCES ${CDM_SCHEMA}.CONCEPT (CONCEPT_ID);
