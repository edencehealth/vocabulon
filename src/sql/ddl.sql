...
CREATE TABLE IF NOT EXISTS ${SCHEMA}.concept_ancestor (
...
CREATE TABLE IF NOT EXISTS ${SCHEMA}.concept_class (
  concept_class_id          VARCHAR(20)   NOT NULL,
...
CREATE TABLE IF NOT EXISTS ${SCHEMA}.domain (
  domain_id          VARCHAR(20)    NOT NULL,
...
CREATE TABLE IF NOT EXISTS ${SCHEMA}.drug_strength (
